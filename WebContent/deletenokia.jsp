      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
          <section class="wrapper">
           <%
		String sql1="select * from nokia";
		ResultSet rs1=DbConnection.FechApple(sql1);
		out.println("<form method='post' action='DeleteNokiaServlet'>");
		%>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                      <div class="content-panel">
                      <h4><i class="fa fa-angle-right"></i> Nokia Products</h4>
                          <section id="unseen">
                            <table class="table table-bordered table-striped table-condensed">
                             ...
                             while(rs1.next())
                             {
                              ...
                              out.println("<tr>");
                              out.println("<td><input type='checkbox' name='mid' value='"+rs1.getString(1)+"'/>"+rs1.getString(1)+"</td>");
