  ...
  <section id="container" >
    ...
    <section id="main-content">
          ...
          <div class="row mt">
                      ...
                      <h4><i class="fa fa-angle-right"></i>Update Samsung Products</h4>
      <%
				String model=request.getParameter("mid");
				out.println("model Id is : "+model);
				String sql1="select * from samsung where mid=?";
				ResultSet rs1=DbConnection.FechSamsung1(sql1,model);
				out.println("<form method='post' action='UpdateSamsungServlet'>");
				out.println("<table>");
				while(rs1.next())
				{
