...
<script src="js/jquery.AntiScroll.min.js"></script>
...
xmlhttp.open("GET","AjaxInternal.jsp?q="+value,true);
...
<div id="ascroll">
<div class='scroll' style="width:30%; height:auto;  position: absolute; z-index: 4;left: 944px;margin-top:418px;top:0px;">
			<div class="chat-box">
			<div id="re">
			</div>
