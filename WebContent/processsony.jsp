  ...
  <section id="container" >
    ...
    <section id="main-content">
          ...
          <div class="row mt">
                      ...
                      <h4><i class="fa fa-angle-right"></i>Update Sony Products</h4>
      <%
				String model=request.getParameter("mid");
				out.println("model Id is : "+model);
				String sql1="select * from sony where mid=?";
				ResultSet rs1=DbConnection.FechSony1(sql1,model);
				out.println("<form method='post' action='UpdateSonyServlet'>");
				out.println("<table>");
				while(rs1.next())
				{
